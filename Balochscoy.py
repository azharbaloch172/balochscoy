#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To Azhar Baloch
...
╒════════════════==========══╕
\033[1;97mFACEBOOK: BALOCH EDIT'X
 \033[1;91mNOTE:DONT' TRY TO COPY
 \033[1;92mDEV•••AZHAR BALOCH
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://www.facebook.com/AZHAR.BALOCH.THE.FATHER.OF.HATERX')
    else:
